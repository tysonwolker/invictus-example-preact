...
var _invictusCore = __webpack_require__(1);
...
var register = _invictusCore.Bootstrapper.register,
    bootstrap = _invictusCore.Bootstrapper.bootstrap;


register('Clock', _Clock2.default);
...
var _invictusPreact = __webpack_require__(2);
...
var ClockWidget = function (_PreactWidget) {
  _inherits(ClockWidget, _PreactWidget);

  function ClockWidget() {
    _classCallCheck(this, ClockWidget);

    return _possibleConstructorReturn(this, (ClockWidget.__proto__ || Object.getPrototypeOf(ClockWidget)).apply(this, arguments));
  }

  _createClass(ClockWidget, [{
    key: 'render',
    value: function render(props) {
      return (0, _preact.h)(_Clock2.default, props);
    }
  }]);

  return ClockWidget;
}(_invictusPreact.PreactWidget);
